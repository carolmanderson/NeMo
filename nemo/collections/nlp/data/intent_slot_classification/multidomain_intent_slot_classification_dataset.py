...
__all__ = ['MultiDomainIntentSlotClassificationDataset', 'MultiDomainIntentSlotInferenceDataset']
...
class MultiDomainIntentSlotClassificationDataset(Dataset):
    """
...
class MultiDomainIntentSlotInferenceDataset(Dataset):
    """
    Creates dataset to use for the task of joint intent
    and slot classification with pretrained model.
